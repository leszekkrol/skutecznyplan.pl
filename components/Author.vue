      ...
      <div class="md:pl-14 md:w-8/12">
        ...
        <p class="mt-4 text-lg tracking-tight">Inicjator i założyciel 
          <a 
            ...
            target="_blank" 
            data-splitbee-event="University of Games"
            data-splitbee-event-destination="universityofgames.net"
        ...
        <p class="mt-4 text-lg tracking-tight">Twórca 
          <a 
            ...
            target="_blank" 
            data-splitbee-event="Napisz Prace"
        ...
        <p class="mt-4 text-lg tracking-tight">Współwłaściciel i CTO 
          <a 
            ...
            target="_blank" 
            data-splitbee-event="Hanzea Tech"
