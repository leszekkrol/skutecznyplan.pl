  ...
  <section class="py-20 sm:py-32">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-24">
        ...
        <h2 class="mt-2 leading-loose font-extrabold tracking-tight text-header sm:text-4xl text-4xl sm:leading-10 lg:leading-relaxed lg:text-6xl">Co mówią słuchacze?</h2>
