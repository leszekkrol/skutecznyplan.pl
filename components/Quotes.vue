    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <ul class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-6 sm:gap-8 lg:mt-20 lg:max-w-none lg:grid-cols-3">
        <li v-for="item in $store.state.quotes" >
          <figure class="relative rounded-2xl bg-gray-800 border border-transparent shadow-md p-6 shadow-xl shadow-slate-900/10">
            ...
            <blockquote class="relative">
              <p class="text-lg tracking-tight text-white">{{ item.description }}</p>
            </blockquote>
